...
net.debug = true;
console.log('net.debug:', net.debug); // Add this line to see the output of net.debug

let isRequestCompleted = true; // Flag to track the completion of the previous request
        ...
        client.on('data', (data) => {
            ...
            postToNewRelic(result, API_KEY, ACCOUNT_ID)
                .then(response => {
                    ...
                    // Send a new request immediately after a successful response
